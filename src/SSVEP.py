...
class SSVEP(object):
    ...
    def __init__(self, mywin= visual.Window([500, 500], fullscr=False, monitor='testMonitor',units='deg'),
                frame_on=5, frame_off=5, trialdur = 5.0, port='/dev/ttyACM0',
                fname='SSVEP.csv', numtrials=1, waitdur=2, mask=None):
        
        #self.mywin = visual.Window([500, 500], pos=mywin, fullscr=False, monitor='testMonitor',units='deg')
        self.mywin = mywin
