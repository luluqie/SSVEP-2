...
#		
	...
	def handle_sample(self, sample):
		...
		chan1 = sample.channel_data[0]

		chan2 = sample.channel_data[1]

		chan3 = sample.channel_data[2]
		...
		#self.f.write(str(stamp)+', '+str(chan1)+', '+str(chan2)+', '+str(chan3)+', '+str(chan4)+', '+str(chan5)+', '+str(chan6)+', '+str(chan7)+', '+str(chan8)+', '+str(0)+'\n')
		self.f.write(str(stamp)+','+str(chan7)+', '+str(0)+'\n')
